...
Hypertension is a major modifiable risk factor for cardiovascular disease and remains one of the leading contributors to morbidity and mortality in the United States. Regular aerobic physical activity has been consistently shown to reduce blood pressure through improvements in vascular endothelial function, autonomic balance, insulin sensitivity, and weight control. The American College of Cardiology and the American Heart Association recommend at least 150 minutes of moderate-intensity aerobic physical activity per week for cardiovascular health promotion and blood pressure reduction(Whelton, P. K., Carey, R. M., Aronow, W. S., et al., 2018).

Epidemiologic evidence demonstrates that individuals who meet aerobic physical activity guidelines have lower prevalence of hypertension compared to physically inactive individuals. A meta-analysis by (Cornelissen, V. A., & Smart, N. A., 2013)) found that aerobic exercise significantly reduces systolic and diastolic blood pressure in both hypertensive and normotensive adults. Similarly, (Physical Activity Guidelines Advisory Committee., 2018) concluded that higher levels of physical activity are associated with lower incidence of hypertension.

In the 2023 New York State BRFSS dataset, aerobic physical activity is categorized using the calculated variable `_PAINDX3`, which classifies respondents as meeting or not meeting the ≥150-minute recommendation. Hypertension status is derived from `_RFHYPE6`, based on whether a health professional has told the respondent they have high blood pressure. Examining the association between these variables allows evaluation of whether adherence to aerobic guidelines is associated with lower hypertension prevalence in this population.
...
The primary research question was whether meeting the aerobic physical activity recommendation was associated with lower odds of self-reported hypertension among adults in the 2023 New York State BRFSS. Because the outcome variable, hypertension, was binary (yes/no), binary logistic regression was selected as the main multivariable analytic approach. A Pearson’s chi-square test was also used as an initial unadjusted test of association between physical activity status and hypertension.


### Analysis steps

The analysis proceeded in four steps. First, the data were restricted to respondents with valid responses for aerobic physical activity, hypertension status, age group, and sex. Second, descriptive statistics and grouped prevalence estimates were calculated for hypertension by physical activity group. Third, a Pearson’s chi-square test was used to assess whether hypertension prevalence differed between those who met and did not meet aerobic activity recommendations. Fourth, a multivariable logistic regression model was fitted with hypertension as the dependent variable and physical activity status as the primary independent variable, adjusting for age group and sex as potential confounders.


### Assumption checks

Several considerations supported the use of logistic regression in this analysis. First, the outcome variable was binary, which is appropriate for a binomial logistic regression model. Second, observations were treated as independent at the respondent level because each row represented one survey participant. Third, the predictors included in the model were categorical variables, so the assumption of linearity between continuous predictors and the log-odds of the outcome was not relevant here. Fourth, cell counts for the exposure and covariates were examined to confirm that categories were adequately populated and that there was no evidence of complete or quasi-complete separation. Finally, model coefficients, standard errors, and confidence intervals were reviewed to confirm stable estimation and interpretable results.

Because this report used a relatively simple prespecified model, formal model selection procedures were not emphasized. Instead, age group and sex were retained in the final model based on epidemiologic relevance as likely confounders of the relationship between physical activity and hypertension.
...
In this analysis of the 2023 New York State BRFSS, meeting the aerobic physical activity recommendation was associated with a lower prevalence and lower adjusted odds of self-reported hypertension. Participants who met the recommended aerobic activity level had a lower hypertension prevalence than those who did not meet the recommendation, and this association remained statistically significant after adjustment for age group and sex.

These findings are consistent with the existing literature suggesting that regular aerobic physical activity is an important protective factor for cardiovascular health. Although the cross-sectional design does not allow causal inference, the results support the public health relevance of promoting physical activity as part of hypertension prevention and control strategies.
...
Yes, I used ChatGPT to assist with this assignment. The tool was used to help refine the analysis plan, improve and debug R code, and strengthen the clarity of the statistical writing.

## Code Availability

The code and supporting files for this report are available in the following GitHub repository:

[https://github.com/Sello0622/6270-2.0.git]
